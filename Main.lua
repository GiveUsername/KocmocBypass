...
information:CreateLabel("Kocmoc Premium Bypass Edition")
information:CreateLabel("Created by Nope#3473")
information:CreateLabel("💀 Do not try to pass this as your own 💀")
information:CreateLabel("📜Re-Executing will result in a Crash/Kick📜")
information:CreateLabel("Bypass Script will Auto-Update | Ver:" ..template.version)
