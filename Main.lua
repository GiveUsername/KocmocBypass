...
information:CreateLabel("---KOCMOC V3 BYPASS EDITION---")
information:CreateLabel("Bypass bye Nope#3473")
information:CreateLabel("💀 Get better Bypass Protection 💀")
information:CreateLabel("📜 Get better Premium Script 📜")
local gainedhoneylabel = information:CreateLabel("Gained Honey: 0")
information:CreateButton("Discord Invite", function() setclipboard("https://discord.gg/kTNMzbxUuZ") end)
information:CreateButton("Bypass Discord Invite", function() setclipboard("https://discord.gg/esr3kEVEPJ") end)
