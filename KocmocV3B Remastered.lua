...
local Config = { WindowName = "KocmocV3 Premium Bypass", Color = Color3.fromRGB(230, 230, 250), Keybind = Enum.KeyCode.Semicolon}
...
information:CreateLabel("KocmocV3 Bypass Edition")
information:CreateLabel("Do not Execute Twice")
